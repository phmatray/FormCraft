...
/// </summary>
public class AsyncFieldDependencyTests : FluentUITestBase
{
    [Fact]
    public async Task Async_DependsOn_Callback_Should_Update_Model_And_UI_After_Settling()
    {
        ...
        var countryInput = component.FindComponents<FluentTextInput>()[0];
        await component.InvokeAsync(() => countryInput.Instance.ValueChanged.InvokeAsync("France"));
        ...
        component.WaitForAssertion(() =>
        {
            ...
            component.FindComponents<FluentTextInput>()[1].Instance.Value.ShouldBe("Capital of France");
        }, TimeSpan.FromSeconds(5));
    }

    [Fact]
    public async Task Async_DependsOn_Callback_Should_Not_Fire_When_Configured_Field_Itself_Changes()
    {
        ...
        var cityInput = component.FindComponents<FluentTextInput>()[1];
        await component.InvokeAsync(() => cityInput.Instance.ValueChanged.InvokeAsync("Antwerp"));
