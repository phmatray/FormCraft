...
- Automatic git-cliff installation
...
git-cliff is automatically installed when running the Changelog target on macOS and Linux. For Windows, install manually:
