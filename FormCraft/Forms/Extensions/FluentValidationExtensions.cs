...
public static class FluentValidationExtensions
{
    ...
    extension<TModel, TProperty>(FieldBuilder<TModel, TProperty> builder) where TModel : new()
    {
        /// <summary>
        ...
        /// </code>
        /// </example>
        public FieldBuilder<TModel, TProperty> WithFluentValidation(Expression<Func<TModel, TProperty>> propertyExpression)
        {
        ...
        /// </code>
        /// </example>
        public FieldBuilder<TModel, TProperty> WithFluentValidator(IValidator<TModel> validator,
